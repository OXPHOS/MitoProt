...
proteome = urllib2.urlopen("file:///Users/zora/Google%20Drive/MitoProt/CE/Caenorhabditis_elegans.WBcel235.pep.all.fa")
...
#            print _, hydrophob_scale_list[_]
    ...
    for choice in range(0, 1):
        ...
        for i in range(0, len(results)):
            results[i] /= sum
            # print results[i]
        results_type.append([info[no][0], results[1]])

for _ in range(0, len(results_type)):
    string = str(results_type[_][0]) + ' ' + str(results_type[_][1])
